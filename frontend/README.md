...
The import validation view first reads the latest import job for the selected period and region. If no latest job is available, it falls back to import job `1` by default. To inspect another fallback job:
